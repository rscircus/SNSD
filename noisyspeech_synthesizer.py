...
#
# Inputs:
# - clean_dir: path to clean speech data
# - noise_dir: path to noisy speech data
# - sampling_rate: sampling rate of clean speech
# - audioformat: audio format of clean speech
# - total_hours: total number of hours of clean speech
# - audio_length: length of clean speech
# - silence_length: length of silence
# - total_snrlevels: total number of SNR levels
# - snr_lower: lower bound of SNR
# - snr_upper: upper bound of SNR
#
#
# Outputs:
# - clean_proc_dir: path to clean speech data
# - noise_proc_dir: path to noisy speech data
# - noisyspeech_dir: path to noisy speech data
# - cleanfilenames: list of clean speech filenames
